...
@HookItem(name = "捡漏历史红包", categories = ["红包与支付"], description = "在联系人与群组详情页面添加选项, 批量扫描当前对话的所有历史红包消息并尝试领取\n点击可查看当前正在进行的任务")
object OpenHistoryRedPackets : ClickableHookItem(), WeContactPrefsScreenApi.IContactInfoProvider, IResolveDex {
